sap.ui.define([
  ...
  QUnit.test("Test BaseController.js existance", function(assert) {
    assert.ok(BaseController, "BaseController doesn't exist" );
    assert.equal(BaseController.getMetadata().getName(), "ui5experts.toolbox.controller.BaseController", "BaseController is not a real ui5experts.toolbox.controller.BaseController" );
  });
